...
class Ui_PythIon(object):
    def setupUi(self, PythIon):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../PythIon/pythionlogo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self._2.addWidget(self.groupBox1)
        self.gridLayout_10.addLayout(self._2, 0, 0, 1, 1)
        ...
        self.eventinfolabel = QtWidgets.QLabel(self.groupBox2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_11.addWidget(self.eventinfolabel, 0, 0, 1, 1)
